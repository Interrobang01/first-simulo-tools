        ...
        local output = runtime_eval({
            ...
            code = [[
                ...
                if square then
                    ...
                    local center = (adjusted_end_point + adjusted_start_point)/2
                    local relative_start = adjusted_start_point - center
                    local relative_end = adjusted_end_point - center
                    local sqrt = math.sqrt(2)
                    adjusted_start_point = (relative_start/sqrt)+center
                    adjusted_end_point = (relative_end/sqrt)+center
                end
                if centerscale then
                ...
                local radius = math.abs((adjusted_end_point-pos):magnitude());
...
function on_pointer_up(point)
    ...
    runtime_eval({
        ...
        code = [[
            ...
            local pos = (input.end_point + input.start_point) / 2;
            local radius = math.abs((input.end_point-pos):magnitude());
